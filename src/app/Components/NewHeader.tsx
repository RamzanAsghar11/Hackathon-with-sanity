...
const NewHeader = () => {
  ...
  return (
    <div>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden w-full flex flex-col items-center gap-5 py-5 text-xl">
          <a href="#" className="hover:text-gray-600" onClick={() => setIsOpen(false)}>Home</a>
          <a href="#" className="hover:text-gray-600" onClick={() => setIsOpen(false)}>Shop</a>
          <a href="#" className="hover:text-gray-600" onClick={() => setIsOpen(false)}>About</a>
          <a href="#" className="hover:text-gray-600" onClick={() => setIsOpen(false)}>Contact</a>
