...
const Contact = () => {
  return (
    <div className='w-full'>
      ...
      <h1 className='font-semibold text-4xl leading-tight text-center mb-8'>Get In Touch With Us</h1>
      <p className='text-[#9F9F9F] text-center font-normal leading-6'>For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. <br /> Our Staff Always Be There To Help You Out. Do Not Hesitate!</p>


 {/* center content */}

      <div className='px-9 lg:px-[400px]  flex flex-col md:flex-row  justify-center'>
